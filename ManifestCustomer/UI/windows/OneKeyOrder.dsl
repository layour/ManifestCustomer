...
<window xmlns:web="http://www.yonyou.com/uapmobile/dsl" id="OneKeyOrder" controller="OneKeyOrderController" namespace="com.lionbridge.customer">
    ...
    <div id="viewPage0">
        ...
        <label id="label0"/>
        <Scrollview id="Scrollview_panel7" vScrollEnabled="always" width="fill" hScrollEnabled="disabled">
            <div id="panel7">
                <div id="panel0">
                ...
                <div id="panel8">
                    ...
                    <label id="label5"/>
                    <div id="panel19">
                        <input id="button4" value="点击添加（如需两提请添加第二发货地址）" class="textbtnclass" type="button"/>
                    </div> 
                </div>
                <div id="panel9">
                    ...
                    <label id="label7"/>
                    <div id="panel21">
                        <input id="button5" value="点击添加（如需两送请添加第二收货地址）" class="textbtnclass" type="button"/>
                    </div> 
                </div>
                <div id="panel10">
